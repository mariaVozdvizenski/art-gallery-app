...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderDate,OrderDetails,OrderStatusCodeId,AppUserId,CreatedBy,CreatedAt,ChangedBy,ChangedAt,Id")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("OrderDate,OrderDetails,OrderStatusCodeId,AppUserId,CreatedBy,CreatedAt,ChangedBy,ChangedAt,Id")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
