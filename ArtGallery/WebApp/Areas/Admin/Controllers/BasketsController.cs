...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class BasketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DateCreated,AppUserId,CreatedBy,CreatedAt,ChangedBy,ChangedAt,Id")] Basket basket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("DateCreated,AppUserId,CreatedBy,CreatedAt,ChangedBy,ChangedAt,Id")] Basket basket)
        {
            if (id != basket.Id)
            {
                return NotFound();
