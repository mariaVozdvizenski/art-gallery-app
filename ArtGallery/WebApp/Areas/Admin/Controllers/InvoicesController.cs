...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InvoiceNumber,InvoiceDate,InvoiceDetails,OrderId,InvoiceStatusCodeId,CreatedBy,CreatedAt,ChangedBy,ChangedAt,Id")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("InvoiceNumber,InvoiceDate,InvoiceDetails,OrderId,InvoiceStatusCodeId,CreatedBy,CreatedAt,ChangedBy,ChangedAt,Id")] Invoice invoice)
        {
            if (id != invoice.Id)
            {
                return NotFound();
