...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,QuizId")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Content,QuizId")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
