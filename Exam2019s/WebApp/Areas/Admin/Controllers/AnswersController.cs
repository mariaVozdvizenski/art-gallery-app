...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class AnswersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,QuestionId,Correct")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Content,QuestionId,Correct")] Answer answer)
        {
            if (id != answer.Id)
            {
                return NotFound();
